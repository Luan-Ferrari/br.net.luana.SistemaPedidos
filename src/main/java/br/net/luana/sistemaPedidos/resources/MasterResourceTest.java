...
public interface MasterResourceTest<T extends MasterDomain, D extends MasterDTO, ID extends Integer> {
    ...
    @PostMapping
    public abstract ResponseEntity<Void> insert(@Valid @RequestBody String json, @RequestBody D dto);
