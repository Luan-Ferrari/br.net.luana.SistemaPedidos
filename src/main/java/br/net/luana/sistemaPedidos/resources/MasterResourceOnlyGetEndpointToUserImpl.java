...
@RestController
public abstract class MasterResourceOnlyGetEndpointToUserImpl<T extends MasterDomain, D extends MasterDTOImpl, ID extends Integer>
        implements MasterResourceOnlyGetEndpointToUser<T, D, ID> {

    @Autowired
    private D dto;
    private MasterService masterService;

    public MasterResourceOnlyGetEndpointToUserImpl(MasterService masterService) {
