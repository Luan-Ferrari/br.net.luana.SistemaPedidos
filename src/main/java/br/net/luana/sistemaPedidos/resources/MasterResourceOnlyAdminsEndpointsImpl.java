...
@RestController
public abstract class MasterResourceOnlyAdminsEndpointsImpl<T extends MasterDomain, D extends MasterDTOImpl, ID extends Integer>
        implements MasterResourceOnlyAdminsEndpoints<T, D, ID> {

    @Autowired
    private D dto;
    private MasterService masterService;

    public MasterResourceOnlyAdminsEndpointsImpl(MasterService masterService) {
