...
@RestController
public abstract class MasterResourceTestImpl<T extends MasterDomain, D extends MasterDTOImpl, ID extends Integer>
        implements MasterResourceTest<T, D, ID> {

    @Autowired
    private D dto;
    private MasterService masterService;

    public MasterResourceTestImpl(MasterService masterService) {
    ...
    @Override
    public ResponseEntity<Void> insert(String json, D dto) {
